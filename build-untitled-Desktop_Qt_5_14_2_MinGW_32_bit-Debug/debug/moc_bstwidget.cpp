...
QT_MOC_LITERAL(1, 10, 10), // "logUpdated"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4) // "text"

    },
    "BSTWidget\0logUpdated\0\0text"
};
...
void BSTWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BSTWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logUpdated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BSTWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BSTWidget::logUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BSTWidget::logUpdated(const QString & _t1)
{
